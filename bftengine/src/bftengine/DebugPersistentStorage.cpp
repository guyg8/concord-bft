...
DebugPersistentStorage::getAndAllocateDescriptorOfLastExitFromView() {
  ...
  for (size_t i = 0; i < elements.size(); i++) {
	...
	ViewChangeMsg* myVCMsg = (ViewChangeMsg*)d.myViewChangeMsg->cloneObjAndMsg();
...
DebugPersistentStorage::getAndAllocateDescriptorOfLastNewView() {
  ...
  DescriptorOfLastNewView retVal{
      d.view, newViewMsg, viewChangeMsgs, myViewChangeMsg, d.stableLowerBoundWhenEnteredToView, d.maxSeqNumTransferredFromPrevViews};
